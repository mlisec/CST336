...
<html>
    ...
    <body>
        ...
        <form style='display: inline-block;' action="logout.php">
            <input style="margin-bottom: 15px;" type ="submit" class='btn btn-danger' id = "beginning" value="Logout"/>
        </form>
        ...
        <div style="margin-top: 15px;" class="tab-content" id="nav-tabContent">
